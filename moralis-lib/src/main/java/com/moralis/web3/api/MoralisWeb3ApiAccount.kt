...
object MoralisWeb3ApiAccount {

    private fun getRetrofitService(): AccountApi {
        val apiClient = ApiClient().addAuthorization(authorization = { it.proceed(it.request().newBuilder().addHeader("X-API-Key", "9W6vnl3GzT7lRm1TztGvWbl3gUFmfHQU3IYAs0zfUbUBj0ptUuItfDa92zuQzpT6").build()) }, authName = "dayzee")
