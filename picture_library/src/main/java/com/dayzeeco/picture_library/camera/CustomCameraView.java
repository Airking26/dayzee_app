package com.dayzeeco.picture_library.camera;
...
import com.dayzeeco.picture_library.camera.listener.CaptureListener;
import com.dayzeeco.picture_library.camera.listener.ClickListener;
import com.dayzeeco.picture_library.camera.listener.ImageCallbackListener;
import com.dayzeeco.picture_library.camera.listener.TypeListener;
import com.dayzeeco.picture_library.camera.view.CaptureLayout;
    ...
    public void initView() {
        ...
        mCaptureLayout.setCaptureListener(new CaptureListener() {
            ...
            public void recordStart() {
                ...
                /*mCameraView.startRecording(createVideoFile(), ContextCompat.getMainExecutor(getContext()), new VideoCapture.OnVideoSavedCallback() {
                            @Override
                            public void onVideoSaved(@NonNull VideoCapture.OutputFileResults outputFileResults) {
                                mVideoFile = new File(outputFileResults.getSavedUri().getPath());
                                ...
                                if (SdkVersionUtils.checkedAndroid_Q() && PictureMimeType.isContent(mConfig.cameraPath)) {
                                    PictureThreadUtils.executeByIo(new PictureThreadUtils.SimpleTask<Boolean>() {
                                        ...
                                        public Boolean doInBackground() {
                                            return AndroidQTransformUtils.copyPathToDCIM(getContext(), new File(""), Uri.parse(mConfig.cameraPath));
                                        }
