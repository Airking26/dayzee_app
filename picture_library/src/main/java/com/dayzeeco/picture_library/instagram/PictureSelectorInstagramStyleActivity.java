...
import com.dayzeeco.picture_library.PictureBaseActivity;
import com.dayzeeco.picture_library.PictureCustomCameraActivity;
import com.dayzeeco.picture_library.PictureMediaScannerConnection;
import com.dayzeeco.picture_library.PictureSelector;
import com.dayzeeco.picture_library.R;
import com.dayzeeco.picture_library.camera.listener.CameraListener;
import com.dayzeeco.picture_library.config.PictureConfig;
import com.dayzeeco.picture_library.config.PictureMimeType;
import com.dayzeeco.picture_library.config.PictureSelectionConfig;
import com.dayzeeco.picture_library.dialog.PhotoItemSelectedDialog;
import com.dayzeeco.picture_library.dialog.PictureCustomDialog;
import com.dayzeeco.picture_library.entity.LocalMedia;
import com.dayzeeco.picture_library.entity.LocalMediaFolder;
import com.dayzeeco.picture_library.instagram.cache.LruCache;
import com.dayzeeco.picture_library.instagram.process.InstagramMediaProcessActivity;
import com.dayzeeco.picture_library.listener.OnAlbumItemClickListener;
import com.dayzeeco.picture_library.listener.OnItemClickListener;
import com.dayzeeco.picture_library.model.LocalMediaLoader;
import com.dayzeeco.picture_library.permissions.PermissionChecker;
import com.dayzeeco.picture_library.style.PictureWindowAnimationStyle;
import com.dayzeeco.picture_library.thread.PictureThreadUtils;
import com.dayzeeco.picture_library.tools.BitmapUtils;
import com.dayzeeco.picture_library.tools.DateUtils;
import com.dayzeeco.picture_library.tools.DoubleUtils;
import com.dayzeeco.picture_library.tools.MediaUtils;
import com.dayzeeco.picture_library.tools.PictureFileUtils;
import com.dayzeeco.picture_library.tools.SPUtils;
import com.dayzeeco.picture_library.tools.ScreenUtils;
import com.dayzeeco.picture_library.tools.SdkVersionUtils;
import com.dayzeeco.picture_library.tools.StringUtils;
import com.dayzeeco.picture_library.tools.ToastUtils;
import com.dayzeeco.picture_library.tools.ValueOf;
import com.dayzeeco.picture_library.widget.FolderPopWindow;
import com.dayzeeco.ucrop.UCrop;
import com.dayzeeco.ucrop.callback.BitmapCropCallback;
import com.dayzeeco.ucrop.callback.BitmapLoadCallback;
import com.dayzeeco.ucrop.model.CutInfo;
import com.dayzeeco.ucrop.model.ExifInfo;
import com.dayzeeco.ucrop.task.BitmapCropTask;
import com.dayzeeco.ucrop.util.BitmapLoadUtils;
            ...
            if (config.selectionMode == PictureConfig.MULTIPLE) {
                if (config.minSelectNum > 0) {
                    if (imageSize < config.minSelectNum) {
                        ToastUtils.s(getContext(), getString(R.string.picture_min_img_num, String.valueOf(config.minSelectNum)));
                        return;
                    }
                }
                if (config.minVideoSelectNum > 0) {
                    if (videoSize < config.minVideoSelectNum) {
                        ToastUtils.s(getContext(), getString(R.string.picture_min_video_num, String.valueOf(config.minVideoSelectNum)));
                        return;
                    }
                }
            }
...
//                            "com.dayzeeco.dayzee.androidView.instaLike.provider", file);
