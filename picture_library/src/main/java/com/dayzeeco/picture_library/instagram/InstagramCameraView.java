    ...
    public InstagramCameraView(@NonNull Context context, AppCompatActivity activity, PictureSelectionConfig config) {
        ...
        mCaptureLayout.setCaptureListener(new InstagramCaptureListener() {
            ...
            public void recordStart() {
                ...
                mCameraView.startRecording(createVideoFile(), ContextCompat.getMainExecutor(getContext().getApplicationContext()), (OnVideoSavedCallback) new OnVideoSavedCallbackImpl(InstagramCameraView.this));
            }
