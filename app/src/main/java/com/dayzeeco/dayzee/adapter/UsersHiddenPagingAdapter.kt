        ...
        fun bindUser(
            ...
            if (userInfoDTO?.picture.isNullOrBlank()){
                ...
                if (userInfoDTO?.isPictureNft!!){
                    itemView.user_hidden_imageview.vertices = 6
                    itemView.user_hidden_imageview.background = null
                }
                else {
                    itemView.user_hidden_imageview.vertices = 0
                    itemView.user_hidden_imageview.background = ResourcesCompat.getDrawable(itemView.resources, R.drawable.border_pic_profile, null)
                }
                Glide
                    .with(itemView)
