...
import kotlinx.android.synthetic.main.item_timenote_root.view.more_label
import kotlinx.android.synthetic.main.item_timenote_root.view.separator_1
import kotlinx.android.synthetic.main.item_timenote_root.view.separator_2
import kotlinx.android.synthetic.main.item_timenote_root.view.timenote_added_by
import kotlinx.android.synthetic.main.item_timenote_root.view.timenote_buy
import kotlinx.android.synthetic.main.item_timenote_root.view.timenote_buy_cl
import kotlinx.android.synthetic.main.item_timenote_root.view.timenote_comment
import kotlinx.android.synthetic.main.item_timenote_root.view.timenote_comment_account
import kotlinx.android.synthetic.main.item_timenote_root.view.timenote_day_month
import kotlinx.android.synthetic.main.item_timenote_root.view.timenote_fl
import kotlinx.android.synthetic.main.item_timenote_root.view.timenote_in_label
import kotlinx.android.synthetic.main.item_timenote_root.view.timenote_indicator
import kotlinx.android.synthetic.main.item_timenote_root.view.timenote_pic_participant_one
import kotlinx.android.synthetic.main.item_timenote_root.view.timenote_pic_participant_one_rl
import kotlinx.android.synthetic.main.item_timenote_root.view.timenote_pic_participant_three
import kotlinx.android.synthetic.main.item_timenote_root.view.timenote_pic_participant_three_rl
import kotlinx.android.synthetic.main.item_timenote_root.view.timenote_pic_participant_two
import kotlinx.android.synthetic.main.item_timenote_root.view.timenote_pic_participant_two_rl
import kotlinx.android.synthetic.main.item_timenote_root.view.timenote_plus
import kotlinx.android.synthetic.main.item_timenote_root.view.timenote_share
import kotlinx.android.synthetic.main.item_timenote_root.view.timenote_time
import kotlinx.android.synthetic.main.item_timenote_root.view.timenote_title
import kotlinx.android.synthetic.main.item_timenote_root.view.timenote_username_desc
import kotlinx.android.synthetic.main.item_timenote_root.view.timenote_year
...
class TimenotePagingAdapter(diffCallbacks: DiffUtil.ItemCallback<TimenoteInfoDTO>,
                            ...
                            private val formatOfDate: Int, private val userInfoDTO: UserInfoDTO?)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return if(viewType == 0) TimenoteViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_timenote, parent, false))
        else TimenoteVideoViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_timenote_video, parent, false))
    }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if(getItem(position)?.video.isNullOrEmpty())
        ...
        else (holder as TimenoteVideoViewHolder).bindTimenote(
            getItem(position)!!,
            timenoteListenerListener,
            fragment,
            isFromFuture,
...
class TimenoteVideoViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
    var timer : CountDownTimer? = null
    ...
    private fun initPlayer(url: String, context: Context) {
        try {
            itemView.exo.player = exoPlayer
            val urlCached = CustomApplicationClass.getProxy(context).getProxyUrl(url)
    ...
    fun bindTimenote(
        ...
        itemView.tag = this
        if(!timenote.pictures.isNullOrEmpty())Glide.with(itemView).load(timenote.pictures[0]).diskCacheStrategy(DiskCacheStrategy.ALL).into(itemView.thumbnail)
        /*itemView.addOnAttachStateChangeListener(object : View.OnAttachStateChangeListener{
            override fun onViewAttachedToWindow(p0: View?) {
                try {
                    itemView.exo.player = exoPlayer
                    val urlCached = CustomApplicationClass.getProxy(itemView.context).getProxyUrl(timenote.video)
                    val dataSourceFactory: DataSource.Factory = DefaultDataSourceFactory(
                        itemView.context, Util.getUserAgent(itemView.context, "VideoPlayer")
                    )
                    val mediaSource: MediaSource =
                        ProgressiveMediaSource.Factory(dataSourceFactory).createMediaSource(
                            Uri.parse(urlCached)
