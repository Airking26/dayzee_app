package com.dayzeeco.dayzee.androidView.carousel
...
import com.dayzeeco.dayzee.databinding.ViewOverlayableImageBinding
import com.dayzeeco.dayzee.model.CarouselImage
import com.dayzeeco.dayzee.model.CarouselImageModel
import kotlinx.android.synthetic.main.activity_carousel_recyclerview_with_gradients.*
...
class CarouselActivity : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.activity_carousel_recyclerview_with_gradients, container, false)
    }
...
internal class CarouselAdapter(private val images: List<CarouselImageModel>) :
...
class OverlayableImageView @JvmOverloads constructor(
    ...
    var image: CarouselImageModel? = null
        set(value) {
            field = value
            value?.let {
