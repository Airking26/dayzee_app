package com.dayzeeco.dayzee.androidView.instaLike.adapter;
...
import com.dayzeeco.dayzee.androidView.instaLike.listener.OnItemLongClickListener;
...
public class GridImageAdapter extends
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.mImg.setImageResource(R.drawable.ic_add_circle_black_24dp);
