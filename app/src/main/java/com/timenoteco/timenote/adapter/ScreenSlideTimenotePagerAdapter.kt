...
class ScreenSlideTimenotePagerAdapter(fa: Fragment, var images: List<String>?, val hideIcons: Boolean, private val itemClickListener: (Int, Int) -> (Unit)) : FragmentStateAdapter(fa) {
