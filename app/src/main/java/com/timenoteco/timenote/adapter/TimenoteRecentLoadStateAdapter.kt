...
class TimenoteRecentLoadStateAdapter(private val retry: () -> Unit) : LoadStateAdapter<TimenoteRecentLoadStateAdapter.LoadStateViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, loadState: LoadState): LoadStateViewHolder {
        return LoadStateViewHolder(
            LayoutInflater.from(parent.context)
                .inflate(R.layout.load_recent_state_view, parent, false)
        )
    }
