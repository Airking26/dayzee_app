package com.timenoteco.timenote.androidView.materialsearchbar.adapter;
...
public abstract class SuggestionsAdapter<S, V extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<V> implements Filterable {
    ...
    public int getListHeight(){
        int height = 0;
        if(getItemCount() == 1) height = getSingleViewHeight();
        else if(getItemCount() > 1) height = 2 * getSingleViewHeight();
        return height;
    }
